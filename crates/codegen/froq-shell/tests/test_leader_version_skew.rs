...
//!   cargo test -p froq-shell --test test_leader_version_skew -- --ignored --nocapture
//! ```
...
/// `signal_leaders_to_relaunch` in `froq-pager-bin/src/main.rs` (which is
