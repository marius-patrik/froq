//! Shared helpers for froq-shell integration tests.

use froq_shell::sampling::{ApiBackend, Client, SamplerConfig};
...
pub mod leader {
    ...
    use froq_test_support::leader::{LeaderFixture, LeaderStdioClient};
...
pub fn test_sampler_config(
    ...
    // Shell `Client` is `froq_sampler::SamplingClient`, which takes a
