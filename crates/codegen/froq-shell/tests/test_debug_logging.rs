...
//! ```bash
//! cargo test -p froq-shell --test test_debug_logging -- --ignored
//! ```
...
/// assert it carries first-party (`froq_grok`) content. Panics with the captured
