...
pub(crate) type GatewayOut = <acp::AgentSide as froq_acp_lib::AcpSide>::OutMessage;
...
pub(crate) fn ctx_with_toggle(toggle: HashMap<String, bool>) -> SubagentSpawnContext {
    ...
    SubagentSpawnContext {
        ...
        fs: Arc::new(froq_workspace::file_system::LocalFs::new(
            PathBuf::from("/tmp"),
        )),
        ...
        parent_skills: None,
        parent_skills_config: froq_agent::prompt::skills::SkillsConfig::default(),
        parent_compat: froq_tools::types::compat::CompatConfig::default(),
        task_completion_reservations: None,
        synthetic_trace_tx: None,
        task_output_tool_name: froq_tools::reminders::task_completion::DEFAULT_TASK_OUTPUT_TOOL
            .to_string(),
...
impl froq_tools::implementations::lsp::LspBackend for DummyLspDispatch {
    ...
    async fn dispatch(
        &self,
        _input: &froq_tools::implementations::lsp::LspToolInput,
    ) -> froq_tools::implementations::lsp::LspToolResult {
        froq_tools::implementations::lsp::LspToolResult {
            text: String::new(),
            is_error: false,
        }
    ...
    ) -> Option<froq_tools::implementations::lsp::DiagnosticsSummary> {
        None
    }
    ...
    ) -> Vec<froq_tools::implementations::lsp::FileDiagnosticEntry> {
        vec![]
    }
}
