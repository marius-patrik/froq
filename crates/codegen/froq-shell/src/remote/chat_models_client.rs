...
impl ChatModelsClient {
    ...
    /// Gated only on a valid grok.com bearer — deliberately NOT `is_froq_auth()`
    ...
    pub async fn list_modes(&self, locale: &str) -> Result<ListModesResponse, ChatModelsError> {
        ...
        let builder = froq_file_utils::trace_context::inject_trace_context_into_request(builder);
