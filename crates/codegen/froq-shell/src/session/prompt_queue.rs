...
//!
//! Canonical definitions live in `froq_prompt_queue`; this re-export keeps every existing
//! `crate::session::prompt_queue::*` and cross-crate `froq_shell::session::prompt_queue::*`
//! path resolving without edits.

pub use froq_prompt_queue::{
