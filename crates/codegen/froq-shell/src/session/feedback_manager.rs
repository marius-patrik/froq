...
pub(crate) fn new_submission(
    ...
    s.shell_version = Some(froq_version::VERSION.to_string());
    s
}
...
pub(crate) async fn submit_feedback_workflow(
    ...
    if telemetry_enabled {
        ...
        froq_telemetry::session_ctx::log_event(froq_telemetry::events::UserFeedback {
...
pub struct FeedbackManager {
    ...
    upload_queue_stats: std::sync::OnceLock<Arc<froq_file_utils::queue::UploadQueueStats>>,
}
...
impl FeedbackManager {
    ...
    pub fn set_upload_queue_stats(&self, stats: Arc<froq_file_utils::queue::UploadQueueStats>) {
    ...
    pub async fn shutdown(&self, queue: Option<&froq_file_utils::queue::UploadQueue>) {
...
mod tests {
    ...
    async fn test_shutdown_with_upload_queue_drains() {
        ...
        use std::sync::Arc;
        use froq_file_utils::queue::{TraceExportSource, UploadQueue, UploadRetryPolicy};
...
mod author_identity_tests {
    ...
    async fn env_var_identity_reaches_the_wire_end_to_end() {
        let _email =
            froq_test_support::env::EnvGuard::set("GROK_TEST_WORK_EMAIL", "ada@corp.example");
        let _name =
            froq_test_support::env::EnvGuard::set("GROK_TEST_WORK_NAME", "Ada Lovelace");
...
"#,
    ...
    async fn workflow_merges_user_metadata_into_submission() {
        let _guard = froq_test_support::env::EnvGuard::set(
            "GROK_USER_METADATA",
