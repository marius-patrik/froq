...
use super::{
    ...
    froq_SESSION_UPDATE_METHOD, collect_prompts_from_events,
};
...
fn search_db_path(root_dir: &Path) -> PathBuf {
    ...
    froq_sqlite_journal::JournalMode::for_db_path(&path).effective_db_path(&path)
}
...
mod tests {
    ...
    fn froq_update(session_update_json: &str) -> String {
        format!(
