...
pub enum SessionCommand {
    ...
    RestorePlanApproval,
    GetToolOverrides {
        respond_to: oneshot::Sender<Option<froq_sampling_types::ToolOverrides>>,
    },
    ...
    SetToolOverrides {
        overrides: froq_sampling_types::ToolOverrides,
    },
    Prompt {
        prompt_id: String,
        ...
        tool_overrides_update: Option<froq_sampling_types::ToolOverridesUpdate>,
    ...
    SetSessionModel {
        sampling_config: froq_sampler::SamplerConfig,
        use_concise: bool,
    ...
    GetModelMetadata {
        responds_to: oneshot::Sender<froq_chat_state::ModelMetadata>,
    },
    ...
    ReloadPlugins {
        registry: Option<std::sync::Arc<froq_agent::plugins::PluginRegistry>>,
    },
    ...
    RepairHistory {
        dry_run: bool,
        respond_to:
            oneshot::Sender<anyhow::Result<froq_chat_state::compaction_utils::HistoryRepairReport>>,
    },
    GetRewindPoints {
    ...
    RecordSubagentUsage {
        by_model: Vec<(String, froq_chat_state::UsageTotals)>,
    ...
    SnapshotToolDefinitions {
        respond_to: oneshot::Sender<Vec<froq_sampling_types::ToolSpec>>,
    },
    ...
    KillBackgroundTask {
        task_id: String,
        respond_to: oneshot::Sender<Result<froq_tools::types::KillOutcome, String>>,
    },
    DeleteScheduledTask {
        task_id: String,
    ...
    ListTasks {
        respond_to: oneshot::Sender<Option<Vec<froq_tools::types::TaskSnapshot>>>,
    },
    ...
    GetHooksList {
        respond_to: oneshot::Sender<froq_hooks_plugins_types::HooksListResponse>,
    },
    /// Execute a hooks management action from the pager modal.
    HooksAction {
        action: froq_hooks_plugins_types::HooksAction,
        respond_to: oneshot::Sender<froq_hooks_plugins_types::ActionOutcome>,
    },
    ...
    PluginsList {
        respond_to:
            oneshot::Sender<Option<std::sync::Arc<froq_agent::plugins::PluginRegistry>>>,
    },
    ...
    /// from the notification bridge, which does not go through `send_froq_notification`).
    ...
    TakeTurnMessages {
        respond_to: oneshot::Sender<Option<froq_chat_state::TurnCapture>>,
    },
    ...
    TakeHarnessTraceTurns {
        respond_to:
            oneshot::Sender<Vec<Vec<froq_sampling_types::conversation::ConversationItem>>>,
    },
