...
use froq_tools::implementations::skills::skill::format_skill_name;
...
pub(super) async fn build_skill_information_for_refs(
    ...
    use froq_tools::implementations::skills::skill::{
...
/// `froq-tools` so it stays identical to the pager's `LoopCommand` and the
