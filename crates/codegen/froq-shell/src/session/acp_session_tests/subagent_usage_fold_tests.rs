...
fn usage_rows() -> Vec<(String, froq_chat_state::UsageTotals)> {
    vec![(
        "m".into(),
        froq_chat_state::UsageTotals {
            input_tokens: 40,
            model_calls: 1,
            ..Default::default()
        },
...
fn usage_drain_outcome_policy_matches_freeze_and_cancel() {
    ...
    use froq_tools::implementations::grok_build::task::types::SubagentOutstandingReply;
