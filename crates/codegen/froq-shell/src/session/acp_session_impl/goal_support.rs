...
impl DrainSource {
    ...
    pub(super) fn into_parts(
        ...
        froq_tools::implementations::grok_build::update_goal::UpdateGoalInput,
        Option<
...
pub(super) fn try_send_ack(
    ack_tx: Option<
        ...
        >,
    >,
    ack: froq_tools::implementations::grok_build::update_goal::UpdateGoalAck,
) {
...
pub(crate) fn goal_slash_and_harness_available(goal_enabled: bool, tool_names: &[String]) -> bool {
    use froq_tools::implementations::grok_build::UPDATE_GOAL_TOOL_NAME;
...
impl SessionActor {
    ...
    pub(super) async fn set_goal_loop_active_resource(&self, active: bool) {
        ...
        self.agent
            ...
            .tool_bridge()
            .update_resource(
                froq_tools::implementations::grok_build::task::types::GoalLoopActive(active),
            )
            .await;
    }
}
