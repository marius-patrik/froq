...
impl SessionActor {
    ...
    pub(super) async fn handle_side_question(&self, question: &str) -> Result<String, String> {
        ...
        let mut items: Vec<ConversationItem> =
            froq_chat_state::compaction_utils::strip_reasoning_blocks(
        ...
        let request = ConversationRequest {
            ...
            x_grok_req_id: Some(format!("froq-btw-{}", uuid::Uuid::new_v4())),
    ...
    pub(super) async fn handle_recap(&self, auto: bool) {
        ...
        let x_grok_req_id = format!("froq-recap-{}", uuid::Uuid::new_v4());
    ...
    pub(super) async fn handle_suggest_prompt(
        ...
        let request = ConversationRequest {
            ...
            x_grok_req_id: Some(format!("froq-promptsuggest-{}", uuid::Uuid::new_v4())),
            x_grok_session_id: Some(self.session_info.id.to_string()),
            x_grok_agent_id: Some(froq_telemetry::id::agent_id()),
            ..Default::default()
        };
        ...
        tracing::debug!(
            raw_preview = %froq_tools::util::truncate_str(raw.trim(), 60),
