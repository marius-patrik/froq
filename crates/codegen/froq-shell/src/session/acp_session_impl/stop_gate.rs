...
/// `description` instead.
fn stop_entry_from_task(task: &froq_tools::types::TaskSnapshot) -> StopBackgroundTask {
    let command_text =
...
fn stop_entry_from_subagent(
    summary: &froq_tools::implementations::grok_build::task::types::ActiveSubagentSummary,
) -> StopBackgroundTask {
    StopBackgroundTask {
...
fn stop_cron_from_scheduled(
    task: &froq_tools::implementations::grok_build::scheduler::types::ScheduledTask,
) -> StopSessionCron {
    StopSessionCron {
        id: task.id.clone(),
        schedule:
            froq_tools::implementations::grok_build::scheduler::interval::interval_to_human(
                task.interval_secs,
            ),
...
impl SessionActor {
    ...
    pub(crate) async fn list_active_subagents(
        &self,
    ) -> Vec<froq_tools::implementations::grok_build::task::types::ActiveSubagentSummary> {
    ...
    async fn announce_keep_working(
        ...
        for block in blocks {
            ...
            .await;
            froq_telemetry::session_ctx::log_event(froq_telemetry::events::HookBlocked {
...
mod stop_gate_snapshot_tests {
    ...
    fn task_snapshot(
        kind: froq_tools::computer::types::TaskKind,
    ...
    fn subagent_summary_maps_to_stop_entry() {
        let summary =
            froq_tools::implementations::grok_build::task::types::ActiveSubagentSummary {
    ...
    fn scheduled_task_maps_to_stop_cron() {
        let task =
            froq_tools::implementations::grok_build::scheduler::types::ScheduledTask::new(
                300,
