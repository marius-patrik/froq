...
pub(crate) enum SamplerTurnOutcome {
    ...
    Response(
        ...
        Box<froq_sampler::InferenceLatencyStats>,
    ),
    CompactAndResubmit,
...
pub(crate) enum DrainSource {
    Pending(froq_tools::implementations::grok_build::update_goal::UpdateGoalInput),
    Channel(froq_tools::implementations::grok_build::update_goal::UpdateGoalEnvelope),
}
