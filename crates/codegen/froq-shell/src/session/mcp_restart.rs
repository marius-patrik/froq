...
//! window containing a [`froq_mcp::servers::McpClientEventKind::TransportClosed`]
//! or [`froq_mcp::servers::McpClientEventKind::HandshakeFailed`] key for a
...
//!    [`froq_mcp::servers::start_mcp_server`] sets
...
//!    push and stop.
//! 5. **Already-Empty** — see the [`froq_mcp::servers::ClientStateKind::Empty`]
...
use froq_mcp::servers::{McpClientEventKind, McpServerName};
