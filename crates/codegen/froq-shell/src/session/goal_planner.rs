...
///
/// [`SubagentRuntimeOverrides::harness_agent_type`]: froq_tools::implementations::grok_build::task::types::SubagentRuntimeOverrides::harness_agent_type
...
mod tests {
    ...
    async fn fail_open_retry_emits_spawn_failed_event() {
        ...
        let writer = froq_file_utils::events::EventWriter::open(dir.path());
        let ov = RoleSpawnOverride {
            model: Some("m".into()),
            agent_type: Some("t".into()),
        };
