...
const froq_SESSION_UPDATE_METHOD: &str = "_x.ai/session/update";
        ...
        updates
            ...
            .map(|update| match update {
                ...
                SessionUpdate::Xai(notification) => {
                    ExportedMessage::from_froq_notification(notification)
                }
            })
            .collect()
    }
