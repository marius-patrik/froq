...
use froq_workflow::{PauseKind, PhaseMeta, WorkflowOutcome};
...
fn capped_pause_message(message: impl Into<String>) -> String {
    ...
    froq_tools::util::truncate_str(&message, WORKFLOW_PAUSE_MESSAGE_MAX_BYTES).to_string()
}
    ...
    pub fn apply_outcome(
        ...
        match outcome {
            ...
            WorkflowOutcome::BudgetExceeded { message } => {
                ...
                let hint = if run.state.agents_used >= froq_workflow::MAX_AGENT_BUDGET {
