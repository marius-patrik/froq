...
fn explicit_override_takes_precedence_over_role() {
    ...
    assert_eq!(
            ...
            Some(froq_tool_types::SubagentCapabilityMode::ReadOnly)
        );
}
#[test]
...
fn partial_override_fills_from_role() {
    ...
    assert_eq!(
            resolved.capability_mode,
            Some(froq_tool_types::SubagentCapabilityMode::Execute)
        );
}
#[test]
...
fn forked_initial_context_inherits_parent_across_reasoning() {
    ...
    let items = vec![
            ...
            ConversationItem::Reasoning(froq_sampling_types::synthesized_reasoning_item(
                "deliberating",
            )),
