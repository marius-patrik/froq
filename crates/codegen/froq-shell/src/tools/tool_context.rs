...
//! froq-tools. This struct is NOT used for tool execution — it's session infrastructure.
//!
...
use froq_workspace::file_system::{AsyncFileSystem, AsyncFsWrapper};
use froq_workspace::session::file_state::FileStateHandle;
...
pub struct ToolContext {
    ...
    pub lsp: Option<Arc<dyn froq_tools::implementations::lsp::LspBackend>>,
    ...
    pub monitor_event_buffer:
        Option<froq_tools::implementations::grok_build::task::types::MonitorEventBuffer>,
    ...
    pub task_wake_suppressed:
        Option<froq_tools::reminders::task_completion::TaskWakeSuppressed>,
...
impl ToolContext {
    ...
    pub fn new(
        ...
        let session_env = froq_workspace::envrc::load_envrc_or_empty_when_trusted(
            cwd.as_path(),
