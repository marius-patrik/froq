//! Retry utilities — re-exported from `froq-tools`.
//!
//! The canonical implementation now lives in `froq_tools::retry`.
//! This module re-exports with backward-compatible aliases.

pub use froq_tools::retry::BackoffConfig as RetryConfig;
pub use froq_tools::retry::{BackoffConfig, execute_with_backoff};
