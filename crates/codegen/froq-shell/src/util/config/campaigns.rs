...
pub async fn persist_models_default(
    value: Option<String>,
    reasoning_effort: Option<froq_sampling_types::ReasoningEffort>,
) -> anyhow::Result<()> {
