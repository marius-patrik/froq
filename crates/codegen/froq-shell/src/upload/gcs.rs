...
//! `StorageClient` constructed inside `froq_file_utils::gcs::*` helpers.
//!
...
//! to an `froq_file_utils::gcs::*` helper.
...
/// shell-side adapter that lets `froq_file_utils::gcs::*` helpers wire
...
///
/// ```ignore
/// froq_file_utils::gcs::upload_bytes(
...
pub(crate) async fn upload_to_auth_diagnostics(
    ...
    match froq_file_utils::gcs::upload_bytes(
