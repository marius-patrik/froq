...
//!
//! The canonical types now live in `froq_sampling_types::conversation`.
...
pub use froq_sampling_types::conversation::*;
...
///
/// Stays in `froq-shell` because it references
...
// via `Box::new(trace)`.
//
// Tests for conversation types now live in froq-sampling-types crate.
