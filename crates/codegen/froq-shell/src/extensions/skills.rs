...
pub async fn handle(
    ...
    match args.method.as_ref() {
        "x.ai/skills/add" => {
            ...
            .await
            {
                froq_telemetry::session_ctx::log_event(
                    froq_telemetry::events::SkillAdded {
                        added_count: 0,
                        total_skills: 0,
                        success: false,
                    },
            ...
            froq_telemetry::session_ctx::log_event(froq_telemetry::events::SkillAdded {
        ...
        "x.ai/skills/remove" => {
            ...
            {
                froq_telemetry::session_ctx::log_event(
                    froq_telemetry::events::SkillRemoved { success: false },
                );
            ...
            froq_telemetry::session_ctx::log_event(froq_telemetry::events::SkillRemoved {
                success: true,
            });
