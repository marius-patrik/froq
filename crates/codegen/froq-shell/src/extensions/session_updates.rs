...
mod tests {
    ...
    fn dummy_gateway() -> froq_acp_lib::AcpAgentGatewaySender {
    ...
    fn capturing_gateway() -> (
        froq_acp_lib::AcpAgentGatewaySender,
        tokio::sync::mpsc::UnboundedReceiver<froq_acp_lib::AcpClientMessage>,
    ) {
        let (tx, rx) = tokio::sync::mpsc::unbounded_channel();
        (froq_acp_lib::AcpAgentGatewaySender::new(tx), rx)
    }
    ...
    fn froq_rewind(target: usize) -> String {
        format!(
