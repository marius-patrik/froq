...
//!
//! Repairs via [`froq_chat_state::compaction_utils::repair_history`]. Resident
...
use froq_chat_state::compaction_utils::HistoryRepairReport;
...
async fn repair_on_disk(grok_root: &std::path::Path, session_id: &str, dry_run: bool) -> ExtResult {
    ...
    let report = froq_chat_state::compaction_utils::repair_history(&mut chat_history);
