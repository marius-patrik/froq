...
//!   here would force every consumer of `froq-workspace-types`
...
//! (`froq-workspace`) wraps this in its own `Request<T>` that
//! adds the cancellation token and extensions map.
//!
//! Splitting the envelope this way keeps `froq-workspace-types`
