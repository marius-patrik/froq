...
// its wire types live in `froq_workspace_types::rpc::fs` (the `ClientFs*`
...
pub use froq_workspace_types::rpc::fs::FsReadEncoding;
...
pub use froq_workspace_types::rpc::search::{ClientId, ContentSearchRequest, TargetClientId};
