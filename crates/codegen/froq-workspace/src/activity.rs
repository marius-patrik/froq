...
use dashmap::DashMap;
use froq_file_utils::events::{Event, EventWriter, ToolOutcome};
use froq_file_utils::queue::UploadQueueStats;
use froq_tool_protocol::{ToolServerLifecycleStatus, ToolServerStatusPayload};
...
impl ActivityTracker {
    ...
    pub fn snapshot_session(&self, session_id: &str) -> ToolServerStatusPayload {
        ...
        ToolServerStatusPayload {
            status,
            session_id: froq_tool_protocol::SessionId::new(session_id).ok(),
            connection_id: None,
