...
pub enum WorkspaceError {
    ...
    ///
    /// [`DeployError`]: froq_workspace_types::rpc::deploy::DeployError
    #[error("deploy error: {message}")]
    DeployError {
        kind: froq_workspace_types::rpc::deploy::DeployError,
        message: String,
    },
...
mod tests {
    ...
    use froq_workspace_types::rpc::deploy::DeployError;
