...
/// [`AuthIdentity`](froq_computer_hub_sdk::AuthIdentity). The two types carry the
...
impl From<froq_computer_hub_sdk::AuthIdentity> for WorkspaceIdentity {
    fn from(id: froq_computer_hub_sdk::AuthIdentity) -> Self {
...
pub struct WorkspaceEnvironment {
    ...
    /// Version of the `froq-workspace` crate that produced the record.
