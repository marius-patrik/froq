...
use froq_file_utils::gcs::StorageConfig;
use froq_file_utils::queue::{EnqueueOutcome, TraceExportSource, UploadQueue};
use froq_file_utils::storage_client::Auth401AttributionCallback;
use froq_file_utils::{TraceExportConfig, UploadMethod};
use froq_auth::{AuthCredentialProvider, CredentialSnapshot};
...
impl froq_auth::visibility::HttpAuth for HubAuthCredentialProvider {
...
mod tests {
    use super::*;
    use froq_computer_hub_sdk::auth::AuthCredential;
