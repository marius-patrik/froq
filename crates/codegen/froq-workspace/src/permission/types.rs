...
impl From<&froq_tools::types::ToolInput> for AccessKind {
    fn from(input: &froq_tools::types::ToolInput) -> Self {
...
mod tests {
    ...
    fn hashline_edit_maps_to_edit_access() {
        use froq_tools::implementations::grok_build_hashline::edit::types::HashlineEditInput;
        use froq_tools::types::ToolInput;
    ...
    fn bash_maps_to_bash_access() {
        use froq_tools::implementations::grok_build::bash::BashToolInput;
        use froq_tools::types::ToolInput;
    ...
    fn use_tool_maps_to_mcp_tool_access() {
        use froq_tools::implementations::use_tool::UseToolInput;
        use froq_tools::types::ToolInput;
    ...
    fn monitor_maps_to_bash_access() {
        use froq_tools::implementations::grok_build::monitor::types::MonitorInput;
        use froq_tools::types::ToolInput;
    ...
    fn web_fetch_maps_to_web_fetch_access() {
        use froq_tools::implementations::grok_build::web_fetch::WebFetchInput;
        use froq_tools::types::ToolInput;
    ...
    fn web_search_maps_to_web_search_access() {
        use froq_tools::implementations::grok_build::web_search::WebSearchInput;
        use froq_tools::types::ToolInput;
