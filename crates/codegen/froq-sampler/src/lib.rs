//! froq-sampler - Actor-based sampling layer for xAI grok.
//!
//! This crate extracts the HTTP streaming + retry logic out of
//! `froq-shell`'s session actor into a standalone, reusable
//! component built on the same actor pattern as `froq-hunk-tracker`.
//!
//! ## Layered API
//!
