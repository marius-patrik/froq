...
impl TerminalContext {
    ...
    pub fn telemetry_snapshot(&self) -> froq_telemetry::events::TerminalTelemetry {
        ...
        froq_telemetry::events::TerminalTelemetry {
            ...
            clipboard_native_tool: froq_shared::clipboard::native_tool_name().to_owned(),
            clipboard_data_control: crate::clipboard::wayland_data_control_label().to_owned(),
        }
    }

    /// Extract terminal info for feedback submissions.
    pub fn feedback_info(&self) -> froq_shared::session::FeedbackTerminalInfo {
        use froq_shared::session::FeedbackTerminalInfo;
        ...
        FeedbackTerminalInfo {
            ...
            clipboard_native_tool: Some(froq_shared::clipboard::native_tool_name().to_owned()),
...
/// `froq-pager-pty-harness/src/pty.rs` (test-env hygiene — the PTY
