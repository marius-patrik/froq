...
//! cargo run -p froq-sandbox --example sandbox_smoke_test
//!
//! # Test strict profile
//! cargo run -p froq-sandbox --example sandbox_smoke_test -- strict
//!
//! # Test read-only profile
//! cargo run -p froq-sandbox --example sandbox_smoke_test -- read-only
//! ```
