# @froq-official/grok-win32-arm64

Platform-specific binary for [`@froq-official/grok`](https://www.npmjs.com/package/@froq-official/grok) on win32-arm64.

Do not install this package directly. Install the main package instead:

```sh
npm install -g @froq-official/grok
```
