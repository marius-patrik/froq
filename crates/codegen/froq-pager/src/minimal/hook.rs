...
//! render mode.
//!
//! `froq-pager` cannot depend on `froq-pager-minimal`: that crate reads
...
//!
//! The composition-root binary (`froq-pager-bin`) wires it up once at
//! startup by calling `froq_pager_minimal::install()`. When nothing has
