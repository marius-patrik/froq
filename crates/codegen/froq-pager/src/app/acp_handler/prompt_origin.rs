...
pub(crate) fn is_server_initiated_prompt(prompt_id: &str) -> bool {
    froq_shell::session::PromptOrigin::from_prompt_id(prompt_id).is_synthetic()
}
...
pub(crate) fn is_scheduler_fired_prompt(prompt_id: &str) -> bool {
    matches!(
        froq_shell::session::PromptOrigin::from_prompt_id(prompt_id),
        froq_shell::session::PromptOrigin::SchedulerFired
    )
}
...
pub(crate) fn is_wake_prompt(prompt_id: &str) -> bool {
    matches!(
        froq_shell::session::PromptOrigin::from_prompt_id(prompt_id),
        froq_shell::session::PromptOrigin::TaskCompleted { .. }
            | froq_shell::session::PromptOrigin::SubagentCompleted { .. }
            | froq_shell::session::PromptOrigin::WorkflowCompleted { .. }
            | froq_shell::session::PromptOrigin::NotificationDrain
    )
}
