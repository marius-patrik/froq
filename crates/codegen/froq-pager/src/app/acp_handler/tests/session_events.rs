#![cfg_attr(rustfmt, rustfmt::skip)]
    ...
    fn retry_exhausted_rate_limited_empty_reason_uses_oauth_fallback() {
        use froq_shell::sampling::error::RATE_LIMITED_USER_MESSAGE_OAUTH;
    ...
    fn retry_exhausted_api_key_rewrites_consumer_subscription_upsell() {
        use froq_shell::sampling::error::RATE_LIMITED_USER_MESSAGE_API_KEY;
    ...
    fn child_compact_started_does_not_reset_context_used() {
        ...
        child_view.context_state = Some(froq_shell::session::ContextInfo::from_notification(
            90_000, 131_072,
        ));
        agent
            .subagent_views
