...
pub(super) fn push_server_status_enabled() -> bool {
    ...
    *ENABLED.get_or_init(|| {
        froq_shell::util::config::resolve_mcp_push_server_status(
...
/// `froq-shell/src/session/acp_session.rs` — toggle-tool ~L6661,
...
///    [`froq_shell::extensions::mcp::McpToolsChanged`] struct), and
...
/// ([`froq_shell::extensions::mcp::McpServerStatusPayload`] +
/// [`froq_shell::extensions::mcp::McpServerStatus`]) instead of
...
pub(super) fn handle_mcp_server_status(notif: &acp::ExtNotification, app: &mut AppView) -> bool {
    ...
    use froq_shell::extensions::mcp::{McpServerStatus, McpServerStatusPayload, McpToolEntry};
...
/// on config reload (`crates/codegen/froq-shell/src/agent/mvp_agent.rs`
