...
/// `froq-shell/src/agent/handlers/session.rs::handle_roster_list`), which
...
mod tests {
    ...
    fn agent_entry() -> froq_shell::agent::roster::RosterEntry {
        use froq_shell::agent::roster as agent;
        agent::RosterEntry {
