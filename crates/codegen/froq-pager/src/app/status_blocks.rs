...
fn format_cost(m: &froq_shell::extensions::notification::PromptUsageModel) -> String {
    use froq_shell::extensions::notification::ticks_to_usd;
...
mod tests {
    use super::*;
    use froq_shell::extensions::notification::{PromptUsage, PromptUsageModel};
