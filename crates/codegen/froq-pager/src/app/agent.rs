...
use froq_shell::extensions::notification::GoalClassifierVerdict;
...
pub struct ChipElement {
    ...
    pub kind: froq_ratatui_textarea::ElementKind,
...
impl AgentSession {
    ...
    /// [`froq_prompt_queue::combine_prefix_len`]. `editing_id` is held out of the
    ...
    pub fn dequeue_combined_prompt(&mut self, editing_id: Option<u64>) -> Option<QueuedPrompt> {
        use froq_prompt_queue::{CombineGate, TEXT_SEPARATOR, combine_prefix_len, join_texts};
