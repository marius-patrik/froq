...
#[test]
#[ignore = "leader-cluster: needs single-process isolation (process-global env + grok_home OnceLock in the shared lib test binary); run: cargo test -p froq-pager --lib -- app::leader_cluster --ignored --test-threads=1"]
