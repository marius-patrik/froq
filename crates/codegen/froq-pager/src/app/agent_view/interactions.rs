...
impl AgentView {
    ...
    fn submit_question_answers(&mut self, skipped: bool) -> InputOutcome {
        use froq_tools::implementations::grok_build::ask_user_question::AskUserQuestionExtResponse;
        self.swap_question_freeform();
        ...
        froq_telemetry::session_ctx::log_event(froq_telemetry::events::PlanSubmit {
...
mod permission_scope_key_tests {
    ...
    fn setup_bash_permission(agent: &mut AgentView) {
        ...
        perm.bash_highlights = Some(
            froq_workspace::permission::bash_command_splitting::BashCommandHighlights {
                prefix: vec![],
