...
fn external_prompt_editor_refuses_elements_with_visible_message() {
    ...
    let image = crate::prompt_images::PastedImage {
        element_id: froq_ratatui_textarea::ElementId::from_raw(0),
        display_number: 0,
...
fn critical_announcement(id: &str) -> froq_announcements::RemoteAnnouncement {
...
fn promo_announcement(id: &str) -> froq_announcements::RemoteAnnouncement {
    froq_announcements::RemoteAnnouncement {
        id: Some(id.into()),
        message: Some(format!("{id} message")),
        severity: Some("promo".into()),
        cta: Some(froq_announcements::AnnouncementCta {
            label: Some("Go".into()),
