...
fn open_extensions_modal_no_session_sets_flag_no_fetches() {
    ...
    let effects = dispatch(
        Action::OpenExtensionsModal {
            ...
            trigger: froq_telemetry::events::ExtensionsModalTrigger::SlashCommand,
        },
        &mut app,
    );
...
fn success_outcome() -> froq_hooks_plugins_types::ActionOutcome {
...
fn empty_marketplace_response() -> froq_hooks_plugins_types::MarketplaceListResponse {
    froq_hooks_plugins_types::MarketplaceListResponse { sources: vec![] }
}
