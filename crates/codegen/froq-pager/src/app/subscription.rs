...
impl AppView {
    ...
    #[must_use]
    pub fn impose_gate(&mut self, gate: froq_shell::auth::GateInfo) -> Vec<Effect> {
    ...
    #[must_use]
    fn defer_gate_for_verification(&mut self, gate: froq_shell::auth::GateInfo) -> Vec<Effect> {
...
mod tests {
    ...
    fn watch_gate() -> froq_shell::auth::GateInfo {
    ...
    fn impose_gate_direct_for_non_consumer_and_already_gated() {
        ...
        let new_copy = froq_shell::auth::GateInfo {
