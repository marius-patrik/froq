...
use froq_shell::session::worktree::META_KEY_LABEL;
...
mod tests {
    ...
    fn make_test_record(metadata: Option<serde_json::Value>) -> froq_fast_worktree::WorktreeRecord {
        use froq_fast_worktree::{WorktreeKind, WorktreeRecord, WorktreeStatus};
        WorktreeRecord {
            id: "test".into(),
            path: "/tmp/wt".into(),
