...
impl MemoryModalState {
    ...
    #[cfg(test)]
    fn query_viewport(&self, width: usize) -> froq_ratatui_textarea::SingleLineViewport {
...
pub fn build_entries(
    files: Vec<froq_shell::extensions::notification::MemoryFileInfo>,
) -> Vec<MemoryFileEntry> {
...
mod tests {
    ...
    fn build_entries_groups_by_source() {
        use froq_shell::extensions::notification::MemoryFileInfo;
