...
use froq_workspace::permission::bash_command_splitting::{
...
pub struct PermissionViewState {
    ...
    pub request: froq_acp_lib::AcpArgs<acp::RequestPermissionRequest>,
    ...
    /// permissions). Imported from `froq-shell`, NOT duplicated locally.
...
mod tests {
    ...
    ///
    /// ```text
    /// PERMISSION_UI_RENDER_REVIEW=1 cargo test -p froq-pager --lib \
    ...
    fn historic_bash_fixture_path() -> std::path::PathBuf {
        // CARGO_MANIFEST_DIR = crates/codegen/froq-pager
