#![cfg_attr(rustfmt, rustfmt::skip)]
    ...
    fn test_image() -> PastedImage {
        PastedImage {
            element_id: froq_ratatui_textarea::ElementId::from_raw(0), // overwritten by insert_image
            display_number: 0,
    ...
    fn fuzzy_result(path: &str, is_dir: bool) -> froq_workspace::file_system::FuzzyMatchResult {
        froq_workspace::file_system::FuzzyMatchResult {
