...
use froq_ratatui_textarea::{ElementId, ElementKind, TextArea, TextAreaState, TextElement};
...
pub struct PromptWidget {
    ...
    hovered_image_element_id: Option<froq_ratatui_textarea::ElementId>,
    /// Image shown immediately after insertion without moving the edit cursor.
    post_insert_image_preview: Option<(froq_ratatui_textarea::ElementId, usize)>,
...
impl PromptWidget {
    ...
    fn handle_key_inner(&mut self, key: &KeyEvent) -> PromptEvent {
        ...
        if changed {
            ...
            if is_backspace_key && !old_text.is_empty() {
                use froq_telemetry::events::BackspaceNoEffect;
    ...
    pub fn handle_mouse(&mut self, mouse: &crossterm::event::MouseEvent) -> PromptEvent {
        use froq_ratatui_textarea::{MouseAction, TextElementEventKind};
    ...
    fn image_element_near_cursor(&self) -> Option<&froq_ratatui_textarea::TextElement> {
    ...
    pub fn textarea(&self) -> &froq_ratatui_textarea::TextArea {
        &self.textarea
    }
...
fn strip_all_elements(
    text: &str,
    cursor: usize,
    textarea: &froq_ratatui_textarea::TextArea,
) -> (String, usize) {
...
fn map_clean_offset_to_raw(
    text: &str,
    clean_offset: usize,
    elements: &[froq_ratatui_textarea::TextElement],
) -> usize {
    if elements.is_empty() {
