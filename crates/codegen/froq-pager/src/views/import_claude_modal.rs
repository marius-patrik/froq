...
use froq_shell::claude_import::{ImportPlan, ImportableItem, PathKind, find_project_root};
...
mod tests {
    use super::*;
    use froq_shell::claude_import::PathKind;
    use froq_workspace::permission::types::{PatternMode, PermissionRule, ToolFilter};
    ...
    fn filtered_plan_respects_per_item_selection_after_grouping() {
        use froq_shell::claude_import::ImportableItem;
