...
use froq_announcements::visible_announcements;
...
fn is_critical(a: &froq_announcements::RemoteAnnouncement) -> bool {
    a.severity.as_deref() == Some("critical")
}

fn is_promo(a: &froq_announcements::RemoteAnnouncement) -> bool {
...
fn is_live_critical(
    ...
    is_critical(a) && !froq_announcements::is_expired_at(a, now)
}
...
fn is_live_promo(
    ...
    is_promo(a) && !froq_announcements::is_expired_at(a, now)
}
...
pub fn is_dismissible(a: &froq_announcements::RemoteAnnouncement) -> bool {
...
fn is_hidden(
    ...
    is_dismissible(a) && hidden_ids.contains(&froq_announcements::announcement_hide_key(a))
}
...
fn usable_cta(a: &froq_announcements::RemoteAnnouncement) -> Option<(&str, &str)> {
...
pub(crate) fn usable_cta_caption(a: &froq_announcements::RemoteAnnouncement) -> Option<&str> {
...
pub fn promo_cta_target<'a>(
    announcements: &'a [froq_announcements::RemoteAnnouncement],
    hidden_ids: &BTreeSet<String>,
) -> Option<(&'a froq_announcements::RemoteAnnouncement, &'a str)> {
...
pub fn session_announcement_hide_keys_at(
    ...
    visible_announcements(announcements)
        ...
        .map(froq_announcements::announcement_hide_key)
        .collect()
}
...
fn render_critical_rows(
    area: Rect,
    buf: &mut Buffer,
    ann: &froq_announcements::RemoteAnnouncement,
    hide_hovered: bool,
) -> BannerHits {
    use unicode_width::UnicodeWidthStr;
...
mod tests {
    use super::*;
    use froq_announcements::RemoteAnnouncement;
    ...
    fn promo(id: &str, message: &str, cta: Option<(&str, &str)>) -> RemoteAnnouncement {
        RemoteAnnouncement {
            ...
            cta: cta.map(|(label, url)| froq_announcements::AnnouncementCta {
    ...
    fn promo_cta_target_requires_usable_pair() {
        ...
        label_only.cta = Some(froq_announcements::AnnouncementCta {
            label: Some("Go".into()),
            url: None,
            caption: None,
        });
