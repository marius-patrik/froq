...
use froq_acp_lib::AcpResult;
use froq_markdown::StreamingMarkdownRenderer;
pub use froq_tools::implementations::grok_build::ask_user_question::{
...
pub enum LocalQuestionKind {
    ...
    CreditLimitUpsell {
        choices: Vec<froq_telemetry::events::CreditLimitChoice>,
    },
    ...
    FreeUsageUpsell {
        ...
        source: froq_telemetry::events::SuperGrokUpsell,
    },
...
impl QuestionViewState {
    ...
    pub fn build_accepted_response(
        &self,
    ) -> froq_tools::implementations::grok_build::ask_user_question::AskUserQuestionExtResponse
    {
    ...
    pub fn send_ext_response(
        &mut self,
        response: froq_tools::implementations::grok_build::ask_user_question::AskUserQuestionExtResponse,
    ) -> bool {
