...
pub enum FixError {
    ...
    Managed(froq_config::managed_text::ManagedConfigError),
    PostconditionFailed,
}
...
impl From<froq_config::managed_text::ManagedConfigError> for FixError {
    fn from(error: froq_config::managed_text::ManagedConfigError) -> Self {
        Self::Managed(error)
    }
}
