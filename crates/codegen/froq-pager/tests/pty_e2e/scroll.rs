...
use froq_pager_pty_harness::PtyHarness;
pub(crate) use froq_pager_pty_harness::{SGR_SCROLL_DOWN, SGR_SCROLL_UP};
...
/// (`froq-pager-pty-harness/src/scroll_matrix/runner.rs`) ports this
...
/// `froq-pager-pty-harness/src/scroll_matrix/session.rs` is a port of
