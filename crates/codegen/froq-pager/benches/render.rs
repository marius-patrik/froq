//! Criterion benchmarks for the froq-pager rendering pipeline.
//!
...
use froq_pager::scrollback::render::render_scrolled_entries_with_scratch;
use froq_pager::scrollback::wrappers::EntryRenderer;
use froq_pager::scrollback::{
