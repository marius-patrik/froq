...
//!
//! ```text
//! cargo bench -p froq-pager --bench edit_highlight
//! cargo bench -p froq-pager --bench edit_highlight -- edit_hl/upgrade
//! ```
...
use froq_pager::diff::{DiffHunk, DiffLine};
use froq_pager::scrollback::blocks::tool::{
...
use froq_pager::syntax::{Syntect, get_syntect};
