...
// Re-export ToolDefinition and FunctionTool from froq-tools.
...
pub use froq_tools::types::definition::{FunctionTool, ToolDefinition};
...
pub struct CreateResponseWrapper {
    ...
    /// froq-specific tool definitions that can't be expressed via
