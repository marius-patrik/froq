...
//!
//! Extracted from `froq-shell/src/agent/subagent/` `resolve_effective_overrides()`.

use std::collections::HashMap;
use std::path::Path;

use serde::de::DeserializeOwned;
use froq_tools::implementations::grok_build::task::types::SubagentRuntimeOverrides;
use froq_tool_types::{SubagentCapabilityMode, SubagentIsolationMode};
...
mod tests {
    use super::*;
    use froq_tools::implementations::grok_build::task::types::ModelOverrideProvenance;
