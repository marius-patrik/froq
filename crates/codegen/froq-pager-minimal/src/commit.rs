...
use froq_pager::appearance::AppearanceConfig;
use froq_pager::minimal_api;
use froq_pager::render::Renderable;
use froq_pager::scrollback::block::RenderBlock;
use froq_pager::scrollback::blocks::ToolCallBlock;
use froq_pager::scrollback::entry::{EntryId, ScrollbackEntry};
...
mod tests {
    ...
    fn btw_block_emits_once_across_repeated_frontier_passes() {
        ...
        s.push(ScrollbackEntry::new(RenderBlock::Btw(
            froq_pager::scrollback::blocks::BtwBlock::new(
                "original question",
                "original answer",
            ),
        )));
    ...
    fn terminal_native_lock_paints_only_native_colors() {
        use ratatui::buffer::Buffer;
        use froq_pager::theme::cache as theme_cache;
        ...
        impl Drop for LockReset {
            fn drop(&mut self) {
                froq_pager::theme::cache::set_terminal_native_lock(false);
            }
        }
    ...
    fn commit_display_mode_lookups_collapse_on_success_only() {
        use froq_pager::scrollback::blocks::{
