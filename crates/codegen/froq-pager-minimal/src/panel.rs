...
use froq_pager::views::extensions_modal::{ExtensionsTab, TabDataState};
use froq_pager::views::modal::ActiveModal;
use froq_pager::views::picker::{self, PickerEntry, PickerField, PickerHitAreas, PickerRow};
...
mod tests {
    use super::*;
    use ratatui::layout::Rect;
    use froq_pager::views::extensions_modal::ExtensionsModalState;
    use froq_pager::views::mcps_modal::{McpServerDisplayStatus, McpServerInfo, McpWireSource};
    ...
    fn session_entry(id: &str) -> froq_pager::app::app_view::SessionPickerEntry {
        froq_pager::app::app_view::SessionPickerEntry {
            id: id.into(),
            summary: id.into(),
    ...
    fn with_resume(entries: Vec<froq_pager::app::app_view::SessionPickerEntry>) -> AgentView {
        let mut a = agent();
        a.active_modal = Some(ActiveModal::SessionPicker {
            ...
            window: froq_pager::views::modal_window::ModalWindowState::new(),
            content_results: None,
            content_loading: false,
            deep_search_seq: 0,
            source_filter: froq_pager::views::session_picker::SourceFilter::default(),
            pending_delete: None,
            entries_query: None,
        });
        a
