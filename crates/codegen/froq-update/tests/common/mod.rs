...
/// binary. Once initialized, `froq_config::grok_home()` will resolve to
...
/// Minimal [`froq_update::UpdateConfig`] for install tests.
pub fn make_update_config(channel: &str) -> froq_update::UpdateConfig {
    froq_update::UpdateConfig {
