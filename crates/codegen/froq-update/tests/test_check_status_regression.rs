...
//!
//! ```text
//! # Mirror returns 403 for the @froq-official scope
...
use froq_update::UpdateConfig;
use froq_update::auto_update::check_update_status;
...
async fn check_status_surfaces_npm_403_in_error_field() {
    ...
    g.set_stderr(
        "npm error code E403\n\
         npm error 403 403 Forbidden - GET https://registry-mirror.example.invalid/api/npm/js-virtual/@froq-official%2fgrok\n\
