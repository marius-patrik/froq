...
//!
//! These structs were extracted from `froq-shell` so they can be
...
impl CompactionScope {
    pub fn begin(
        ...
        let percentage = froq_token_estimation::usage_percentage_u8(tokens_used, context_window);
...
pub struct ToolCallCompleted {
    pub tool_name: String,
    pub outcome: froq_file_utils::events::types::ToolOutcome,
    pub duration_ms: u64,
...
// ---------------------------------------------------------------------------
// Pager events (called from froq-pager via log_event)
// ---------------------------------------------------------------------------
