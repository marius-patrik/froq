...
//!
//! Provides a dedicated tracing target (`froq_memory`) with an optional
...
pub const TARGET: &str = "froq_memory";
...
mod inner {
    ...
    ///
    /// Writes to `~/.grok/logs/memory.log`. Filters to `froq_memory=trace`.
