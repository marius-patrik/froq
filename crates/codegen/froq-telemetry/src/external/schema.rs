...
/// Built-in tool names (closed enum surface in `froq-tools`) that pass
...
fn tool_outcome_label(o: &froq_file_utils::events::types::ToolOutcome) -> &'static str {
    use froq_file_utils::events::types::ToolOutcome;
    match o {
