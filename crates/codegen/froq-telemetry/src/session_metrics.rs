...
impl TraceUploadReason {
    ...
    pub fn from_upload_method(method: &Option<froq_file_utils::UploadMethod>) -> Self {
        match method {
            Some(froq_file_utils::UploadMethod::Proxy { .. }) => Self::Proxy,
            Some(froq_file_utils::UploadMethod::S3 { .. }) => Self::DirectS3,
            Some(froq_file_utils::UploadMethod::Direct { .. }) => Self::DirectGcs,
...
#[cfg(test)]
mod tests {
    use froq_file_utils::UploadMethod;
