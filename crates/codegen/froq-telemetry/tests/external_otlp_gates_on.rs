...
use froq_telemetry::external::{self, ExternalOtelRemotePolicy, IdentityAttrs};
...
fn external_stream_gates_on_end_to_end() {
    ...
    froq_telemetry::log_event(froq_telemetry::events::ToolCallCompleted {
        tool_name: "github__create_issue".into(),
        outcome: froq_file_utils::events::types::ToolOutcome::Success,
        duration_ms: 12,
