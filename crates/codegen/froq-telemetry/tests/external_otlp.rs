...
fn external_stream_end_to_end() {
    ...
    let mut cfg = froq_telemetry::external::ExternalOtelConfig::resolve_with(
        |name| match name {
    ...
    cfg.client = froq_telemetry::external::config::ExternalClientInfo {
        service_version: "0.0.0-test".into(),
        client_version: "0.0.0-test".into(),
        app_entrypoint: "cli".into(),
    };

    froq_telemetry::external::init(Some(cfg));
    assert!(froq_telemetry::external::is_active());
    ...
    assert!(!froq_telemetry::is_enabled());
    froq_telemetry::log_event(froq_telemetry::events::SessionNew {
        session_id: "sess-int-1".into(),
        client_identifier: None,
        client_version: None,
        is_git_repo: true,
        permission_mode: froq_telemetry::enums::PermissionMode::Ask,
    });
    froq_telemetry::log_event(froq_telemetry::events::SessionHarness {
        session_id: "sess-int-1".into(),
    ...
    froq_telemetry::log_event(froq_telemetry::events::PromptSubmitted {
    ...
    froq_telemetry::log_event(froq_telemetry::events::ModelResponseReceived {
    ...
    froq_telemetry::external::shutdown();
    assert!(
