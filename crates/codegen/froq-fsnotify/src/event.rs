//! Public event types — the wire contract for `froq-fsnotify`.
//!
...
//! translator (in `froq-workspace`) maps these to
...
/// Aligned with `froq_workspace_types::FsEventKind` (identity map at
