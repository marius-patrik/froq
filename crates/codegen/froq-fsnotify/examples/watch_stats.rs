...
//! cargo run --release -p froq-fsnotify --example watch_stats -- gen js /tmp/js-repo
//! GROK_FSNOTIFY_PER_DIR=0 cargo run --release -p froq-fsnotify --example watch_stats -- run /tmp/js-repo 5
//! GROK_FSNOTIFY_PER_DIR=1 cargo run --release -p froq-fsnotify --example watch_stats -- run /tmp/js-repo 5
//! ```
//!
...
use froq_fsnotify::{FsConfig, FsEventSource};
