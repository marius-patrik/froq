...
impl froq_tool_runtime::ToolOutput for SchedulerDeleteOutput {}
...
impl froq_tool_runtime::Tool for SchedulerDeleteTool {
    type Args = SchedulerDeleteInput;
    type Output = SchedulerDeleteOutput;

    fn id(&self) -> froq_tool_protocol::ToolId {
        froq_tool_protocol::ToolId::new("scheduler_delete").expect("valid tool id")
    }
    ...
    ) -> Result<SchedulerDeleteOutput, froq_tool_runtime::ToolError> {
