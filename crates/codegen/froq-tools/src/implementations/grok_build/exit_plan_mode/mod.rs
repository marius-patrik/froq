...
Use this after you have finished writing your plan to the plan file in plan mode."#
    ...
    fn requires_expr(&self) -> Expr<ToolRequirement> {
        ...
        Expr::Value(ToolRequirement::Tool {
            ...
            .to_string(),
            id: froq_tool_runtime::Tool::id(&EnterPlanModeTool).to_string(),
            if_params: None,
        })
    }
}

impl froq_tool_runtime::Tool for ExitPlanModeTool {
    type Args = ExitPlanModeInput;
    type Output = ExitPlanModeOutput;

    fn id(&self) -> froq_tool_protocol::ToolId {
        froq_tool_protocol::ToolId::new("exit_plan_mode").expect("valid tool id")
    }
    ...
    ) -> Result<ExitPlanModeOutput, froq_tool_runtime::ToolError> {
...
mod tests {
    ...
    fn tool_name_and_description() {
        ...
        assert_eq!(froq_tool_runtime::Tool::id(&tool).as_str(), "exit_plan_mode");
    ...
    fn tool_is_read_only() {
        assert!(froq_tool_runtime::Tool::capabilities(&ExitPlanModeTool).is_read_only);
    }
