...
impl froq_tool_runtime::Tool for MemorySearchImpl {
    type Args = MemorySearchInput;
    type Output = ToolOutput;

    fn id(&self) -> froq_tool_protocol::ToolId {
        froq_tool_protocol::ToolId::new("memory_search").expect("valid tool id")
    }
        ...
        let results = memory
            ...
            .map_err(|e| {
                froq_tool_runtime::ToolError::execution(
                    froq_tool_protocol::ToolId::new("memory_search").expect("valid"),
