...
impl froq_tool_runtime::Tool for MemoryGetImpl {
    type Args = MemoryGetInput;
    type Output = ToolOutput;

    fn id(&self) -> froq_tool_protocol::ToolId {
        froq_tool_protocol::ToolId::new("memory_get").expect("valid tool id")
    }
        ...
        let content = memory
            ...
            .map_err(|e| {
                froq_tool_runtime::ToolError::execution(
                    froq_tool_protocol::ToolId::new("memory_get").expect("valid"),
