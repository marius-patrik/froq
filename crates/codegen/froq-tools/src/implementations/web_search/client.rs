...
impl WebSearchClient {
    ...
    pub fn new(
        ...
        let WebSearchConfig::Enabled {
            ...
            return Err(froq_tool_runtime::ToolError::execution(
                froq_tool_protocol::ToolId::new("web_search").expect("valid"),
    ...
    pub async fn search(
    ...
    ) -> Result<(String, Vec<String>), froq_tool_runtime::ToolError> {
        ...
        if status == reqwest::StatusCode::UNAUTHORIZED {
            ...
            return Err(froq_tool_runtime::ToolError::unauthorized(format!(
    ...
    pub async fn search_with_titles(
        ...
        query: &str,
        allowed_domains: Option<Vec<String>>,
    ) -> Result<(String, Vec<(String, String)>), froq_tool_runtime::ToolError> {
        let web_search = rs::WebSearchToolArgs::default()
            .filters(rs::WebSearchToolFilters { allowed_domains })
            .build()
            .map_err(|e| {
