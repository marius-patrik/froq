...
use froq_tool_types::SubagentCompletedOutput;
...
pub(crate) fn typed_tool_output_preserving_cco(
    ...
    source: &impl froq_tool_runtime::ToolOutput,
) -> froq_tool_runtime::TypedToolOutput {
    let cco = source.chat_completion_output();
    let value = serde_json::to_value(payload).unwrap_or(serde_json::Value::Null);
    froq_tool_runtime::TypedToolOutput::from_value(tool_id, value).with_chat_completion_output(cco)
}
...
/// protocol boundary in `froq-shell`.
#[derive(Debug, Clone, Serialize, Deserialize, schemars::JsonSchema)]
...
use froq_tool_types::KillTaskOutput;
...
impl froq_tool_runtime::ToolOutput for BashToolOutput {
    fn chat_completion_output(&self) -> Option<froq_tool_runtime::ToolChatCompletionResponse> {
        match self {
            Self::Bash(bash) => froq_tool_runtime::ToolOutput::chat_completion_output(bash),
...
impl froq_tool_runtime::ToolOutput for ToolOutput {
    fn chat_completion_output(&self) -> Option<froq_tool_runtime::ToolChatCompletionResponse> {
        match self {
            Self::Bash(bash) => froq_tool_runtime::ToolOutput::chat_completion_output(bash),
            _ => None,
...
impl froq_tool_runtime::ToolOutput for BashOutput {
    fn chat_completion_output(&self) -> Option<froq_tool_runtime::ToolChatCompletionResponse> {
        ...
        Some(froq_tool_runtime::ToolChatCompletionResponse {
            result: Some(froq_tool_runtime::ToolChatCompletion {
                sender: "assistant".into(),
                message_tag: Some("raw_function_result".into()),
                code_execution_result: Some(froq_tool_runtime::ToolCodeExecutionResult {
                    stdout,
                    stderr: String::new(),
...
impl froq_tool_runtime::ToolOutput for GrepSearchOutput {}
impl froq_tool_runtime::ToolOutput for ReadFileOutput {}
impl froq_tool_runtime::ToolOutput for ListDirOutput {}
impl froq_tool_runtime::ToolOutput for SearchReplaceOutput {}
impl froq_tool_runtime::ToolOutput for TodoWriteOutput {}
impl froq_tool_runtime::ToolOutput for WebSearchOutput {}
impl froq_tool_runtime::ToolOutput for WebFetchOutput {}
impl froq_tool_runtime::ToolOutput for SkillOutput {}
impl froq_tool_runtime::ToolOutput for ApplyPatchOutput {}
impl froq_tool_runtime::ToolOutput for CodexGrepFilesOutput {}
impl froq_tool_runtime::ToolOutput for SearchToolOutput {}
impl froq_tool_runtime::ToolOutput for EnterPlanModeOutput {}
impl froq_tool_runtime::ToolOutput for ExitPlanModeOutput {}
impl froq_tool_runtime::ToolOutput for AskUserQuestionOutput {}
impl froq_tool_runtime::ToolOutput for MCPOutput {}
#[cfg(test)]
mod tests {
    use super::*;
    use crate::implementations::grok_build::todo::{TodoPriority, TodoStatus};
    use serde_json::json;
    use froq_tool_types::KillTaskResult;
    use froq_tool_types::TaskOutputResult;
    ...
    fn assert_cer(
        resp: &froq_tool_runtime::ToolChatCompletionResponse,
        stdout: &str,
        exit_code: i32,
        timed_out: bool,
    ) {
    ...
    fn bash_output_chat_completion_carries_exit_and_stdout() {
        let resp = froq_tool_runtime::ToolOutput::chat_completion_output(&sample_bash(
            0, b"hello\n", false,
        ))
        .unwrap();
    ...
    fn bash_output_chat_completion_empty_stdout_still_emits() {
        let resp =
            froq_tool_runtime::ToolOutput::chat_completion_output(&sample_bash(0, b"", false))
                .unwrap();
    ...
    fn bash_output_chat_completion_truncation_marker_and_extra() {
        ...
        let resp = froq_tool_runtime::ToolOutput::chat_completion_output(&bash).unwrap();
        let result = resp.result.as_ref().unwrap();
    ...
    fn bash_tool_output_foreground_delegates_background_skips() {
        let resp = froq_tool_runtime::ToolOutput::chat_completion_output(&BashToolOutput::Bash(
            sample_bash(0, b"ok", false),
        ))
        .unwrap();
        assert_cer(&resp, "ok", 0, false);
        assert!(
            froq_tool_runtime::ToolOutput::chat_completion_output(
    ...
    fn aggregate_tool_output_bash_delegates_background_skips() {
        let resp = froq_tool_runtime::ToolOutput::chat_completion_output(&ToolOutput::Bash(
        ...
        assert!(
            froq_tool_runtime::ToolOutput::chat_completion_output(&ToolOutput::Text(
    ...
    fn bash_tool_id() -> froq_tool_protocol::ToolId {
        froq_tool_protocol::ToolId::new("bash").unwrap()
    }
    #[test]
    fn into_typed_tool_output_preserves_bash_foreground_cco() {
        ...
        let dropped = froq_tool_runtime::TypedToolOutput::from_value(typed.tool_id, expected_value);
    ...
    fn into_typed_tool_output_non_bash_cco_is_none() {
        ...
        let typed = run.into_typed_tool_output(froq_tool_protocol::ToolId::new("text").unwrap());
