...
//!
//! All implementations now live in the lightweight [`froq_tty_utils`] crate
//! so that every crate in the workspace can use them without pulling in the
//! heavyweight `froq-tools` dependency. This module re-exports the public
//! API for backward compatibility.

pub use froq_tty_utils::{detach_from_tty, pager_env};
