...
//! Run:
//! ```bash
//! cargo test -p froq-tools --test path_suggestions_production
//! ```

use std::path::PathBuf;
use tempfile::TempDir;
use froq_tools::util::path_suggestions::{format_not_found_error, path_not_found_hint};
...
fn similar_names(hint: &froq_tools::util::path_suggestions::PathNotFoundHint) -> Vec<String> {
    hint.similar
        .iter()
