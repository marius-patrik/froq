//! Integration tests for froq-hooks.
//!
...
use froq_hooks::discovery::load_hooks;
use froq_hooks::dispatcher;
use froq_hooks::event::*;
use froq_hooks::result::HookDecision;
use froq_hooks::runner::RunContext;
    ...
    let cases = vec![
        ...
        Case {
            ...
            payload: HookPayload::StopFailure {
                error: froq_hooks::event::StopFailureKind::RateLimit,
