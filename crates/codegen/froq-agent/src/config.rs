...
pub fn grok_build_hashline_toolset(
    hashline_tools: Vec<froq_tools::registry::types::ToolConfig>,
) -> ToolServerConfig {
    let mut tools: Vec<froq_tools::registry::types::ToolConfig> = vec![bash_tool_config()];
...
pub struct AgentDefinition {
    ...
    pub capability_mode: Option<froq_tool_types::SubagentCapabilityMode>,
    #[serde(default)]
...
/// these into `froq_tools::registry::types::ToolsetConfig.bash`
...
impl AgentDefinition {
    ...
    fn scope_from_path(path: &Path) -> AgentScope {
        ...
        let grok = froq_config::user_grok_home();
...
impl AgentDefinition {
    ...
    pub fn override_file_tools(
        &mut self,
        file_tools: Vec<froq_tools::registry::types::ToolConfig>,
    ) {
    ...
    pub fn general_purpose() -> Self {
        ...
        Self {
            description: froq_tool_types::GENERAL_PURPOSE_SUBAGENT
                .description
                .to_string(),
    ...
    pub fn explore() -> Self {
        use crate::prompt::subagent_prompts;
        Self {
            description: froq_tool_types::EXPLORE_SUBAGENT.description.to_string(),
    ...
    pub fn plan() -> Self {
        use crate::prompt::subagent_prompts;
        Self {
            description: froq_tool_types::PLAN_SUBAGENT.description.to_string(),
