...
//!
//! Run with: cargo test -p froq-mcp --test repro_sse_flood -- --nocapture
...
use froq_mcp::mcp_http_client::{McpHttpClient, WarnBudget};
use froq_mcp::rmcp::ServiceExt;
use froq_mcp::rmcp::transport::StreamableHttpClientTransport;
use froq_mcp::rmcp::transport::streamable_http_client::StreamableHttpClientTransportConfig;
