...
use serde_json::json;
use froq_computer_hub_core::{error_from_envelope, tool_error_from_wire};
use froq_tool_protocol::{JsonRpcError, RequestId, ToolErrorWire};
use froq_tool_runtime::ToolErrorKind;
