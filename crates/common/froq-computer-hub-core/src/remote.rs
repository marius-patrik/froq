...
fn map_block(block: froq_tool_protocol::McpBlock) -> ContentBlock {
    use froq_tool_protocol::McpBlock;
    match block {
...
pub fn error_from_envelope(err: froq_tool_protocol::JsonRpcError) -> ToolError {
