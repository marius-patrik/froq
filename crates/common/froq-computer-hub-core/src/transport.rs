...
//!
//! [`TransportKind`] is re-exported from [`froq_tool_protocol`] so the wire
...
use froq_tool_protocol::{SessionId, ToolId, UserId};
use froq_tool_runtime::{ToolCallContext, ToolError, ToolStream, TypedToolOutput};

pub use froq_tool_protocol::TransportKind;
