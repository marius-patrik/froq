...
pub struct ToolCallResult {
    ...
    /// this crate must not depend on `froq-tool-runtime`. Sampler-side wire
...
/// `froq_computer_hub_core::registry::ToolSessionBindOutcome`, with one
...
pub struct ToolsListResult {
    pub tools: Vec<froq_tool_types::ToolDescription>,
}
