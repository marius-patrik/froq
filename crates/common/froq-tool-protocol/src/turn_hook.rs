...
pub struct BeforeTurnPayload {
    ...
    /// (`"primary"` | `"subagent"`). A `String`, not the `froq-file-utils`
...
pub struct AfterTurnPayload {
    ...
    /// the workspace decodes it into the `froq-file-utils`
