...
/// Numeric JSON-RPC code for overload rejection (`froq-tool-protocol`
...
const GLOBAL_MAX_INFLIGHT_ENV: &str = "froq_TOOL_SERVER_GLOBAL_MAX_INFLIGHT";
...
/// `froq_TOOL_SERVER_GLOBAL_MAX_INFLIGHT` when present and parseable as a
